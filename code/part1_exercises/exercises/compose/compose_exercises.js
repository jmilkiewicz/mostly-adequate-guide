...
var sanitizeNames =  map(_.compose( _.toLower,_underscore,_.prop('name')));
...
var availablePrices = _.compose(_.join(', '),_.map(formatDollarValue) ,_.filter(_.prop('in_stock')));
...
var fastestCar = _.compose(function(s){ return s+' is the fastest';} ,_.prop('name') ,_.last,_.sortBy(_.prop('horsepower')))
